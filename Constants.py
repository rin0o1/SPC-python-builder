...
class Constants:
    ...
    SPC_OUT = "spcOut"
    CANDL_GRID_DIMENSION_X = "DX"
    CANDL_GRID_DIMENSION_Y = "DY"
    CANDL_INSTANCES = "instances"
    CANDL_COMMENT_DIMENSIONS = "dimensions"
    CANDL_COMMENT_NUMBER_OF_INSTANCE_COMPLEX_OBJECT = "instances"
